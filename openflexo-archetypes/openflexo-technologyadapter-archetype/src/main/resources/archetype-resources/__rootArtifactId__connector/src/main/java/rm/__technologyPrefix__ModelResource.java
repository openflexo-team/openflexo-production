...
public abstract interface ${technologyPrefix}ModelResource extends FlexoFileResource<${technologyPrefix}Model>, FlexoModelResource<${technologyPrefix}Model, ${technologyPrefix}MetaModel>
{
